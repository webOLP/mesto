...
export const popupAvatarInput = popupAvatar.querySelector('.form__input');
export const likeCounter = placeTemplate.querySelector('.places__like-counter');
...
export const profileImage = document.querySelector('.profile__image-cover');
